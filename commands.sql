...
-- Note: This attempts to register the storage bucket; if running inside Supabase Dashboard,
-- storage schema might require direct inserts into storage.buckets.
